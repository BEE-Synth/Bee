...
namespace LibBee.Bottom
{
    internal static class Interfaces
    {
        ...
        public static extern bool SynthesizeBidirectional(UIntPtr synthesizer, int timeOutMilli, int numHypothesized, int numFeatures, bool concat);
        
        [DllImport(DllPath, EntryPoint = "synthesize_forward")]
        public static extern bool SynthesizeForward(UIntPtr synthesizer, int timeOutMilli, bool concat);
